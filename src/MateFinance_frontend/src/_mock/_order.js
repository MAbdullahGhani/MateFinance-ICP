...
export const LENDER_STATUS_OPTIONS = [
  { value: 'inProgress', label: 'In Progress', color: 'info', show: false },
  { value: 'approve', label: 'Approved', color: 'primary', show: true },
  { value: 'rejected', label: 'Rejected', color: 'error', show: true },
  { value: 'needMoreDetails', label: 'Need More Details', color: 'warning', show: true },
];
