...
// ----------------------------------------------------------------------
const ArrowDownIcon = (props) => (<SvgIcon {...props}>
...
const CheckboxIcon = (props) => (<SvgIcon {...props}>
...
const CheckboxCheckedIcon = (props) => (<SvgIcon {...props}>
...
const CheckboxIndeterminateIcon = (props) => (<SvgIcon {...props}>
...
const RatingIcon = (props) => (<SvgIcon {...props}>
...
const TreeViewCollapseIcon = (props) => (<SvgIcon {...props}>
...
const TreeViewExpandIcon = (props) => (<SvgIcon {...props}>
...
const TreeViewEndIcon = (props) => (<SvgIcon {...props}>
    ...
    return {
        ...
        MuiDataGrid: {
            defaultProps: {
                slots: {
                    // column
                    columnSortedAscendingIcon: () => (<Iconify width={20} icon="solar:alt-arrow-up-bold-duotone" sx={{ color: 'text.primary' }}/>),
                    columnSortedDescendingIcon: () => (<Iconify width={20} icon="solar:alt-arrow-down-bold-duotone" sx={{ color: 'text.primary' }}/>),
                    columnUnsortedIcon: () => (<Iconify width={20} icon="solar:alt-arrow-up-bold-duotone" sx={{ color: 'text.disabled' }}/>),
