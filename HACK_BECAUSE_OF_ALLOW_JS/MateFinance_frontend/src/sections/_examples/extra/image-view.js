...
export default function ImageView() {
    return (<>
      <ComponentHero>
        <CustomBreadcrumbs heading="Image" links={[
            {
                name: 'Components',
        ...
        <Stack spacing={5}>
          <Card>
            ...
            md: 'repeat(4, 1fr)',
              ...
              {IMAGES.map((img) => (<Image key={img.ratio} alt={img.ratio} src={img.url} sx={{ borderRadius: 2 }}/>))}
            </Box>
          </Card>
          ...
          <Card>
            ...
            md: 'repeat(4, 1fr)',
              ...
              {IMAGES.map((img) => (<Stack key={img.ratio} spacing={1}>
