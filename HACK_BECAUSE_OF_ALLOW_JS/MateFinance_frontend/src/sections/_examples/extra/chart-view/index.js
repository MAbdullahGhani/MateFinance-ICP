...
export default function ChartView() {
    return (<>
      <ComponentHero>
        <CustomBreadcrumbs heading="Chart" links={[
            {
                name: 'Components',
