...
function MapHighlightByFilter({ ...other }) {
    ...
    return (<Map initialViewState={{
            ...
            longitude: -98,
            zoom: 3,
        }} minZoom={2} onMouseMove={onHover} interactiveLayerIds={['counties']} {...other}>
      <MapControl />
      ...
      {selectedCounty && hoverInfo && (<MapPopup longitude={hoverInfo.longitude} latitude={hoverInfo.latitude} closeButton={false}>
