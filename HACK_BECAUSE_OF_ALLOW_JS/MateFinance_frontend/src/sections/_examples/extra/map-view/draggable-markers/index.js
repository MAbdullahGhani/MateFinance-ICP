...
function MapDraggableMarkers({ ...other }) {
    ...
    return (<>
      <Map initialViewState={{ latitude: 40, longitude: -100, zoom: 3.5 }} {...other}>
        ...
        <MapMarker longitude={marker.longitude} latitude={marker.latitude} anchor="bottom" draggable onDragStart={onMarkerDragStart} onDrag={onMarkerDrag} onDragEnd={onMarkerDragEnd}/>
      </Map>
