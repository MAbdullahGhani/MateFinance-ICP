...
export default function SnackbarView() {
    ...
    const onSnackbarAction = (color, anchor) => {
        enqueueSnackbar(`This is an ${color}`, {
            ...
            anchorOrigin: anchor,
            action: (key) => (<>
          <Button size="small" color={color !== 'default' ? color : 'primary'} onClick={() => {
    ...
    return (<>
      <ComponentHero>
        <CustomBreadcrumbs heading="Snackbar" links={[
            {
                name: 'Components',
      ...
      <Container sx={{ my: 10 }}>
        <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
          <ComponentBlock title="Simple">
            ...
            <Button variant="contained" color="info" onClick={() => enqueueSnackbar('This is an info', {
            variant: 'info',
        })}>
              Info
            </Button>
            ...
            <Button variant="contained" color="warning" onClick={() => enqueueSnackbar('This is an warning', {
            variant: 'warning',
        })}>
              Warning
            </Button>
            <Button variant="contained" color="error" onClick={() => enqueueSnackbar('This is an error', {
            variant: 'error',
        })}>
              Error
            </Button>
