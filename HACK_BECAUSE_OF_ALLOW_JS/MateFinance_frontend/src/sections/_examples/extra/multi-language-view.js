...
export default function MultiLanguageView() {
    ...
    return (<>
      <ComponentHero>
        <CustomBreadcrumbs heading="Multi Language" links={[
            {
                name: 'Components',
        ...
        <Grid container spacing={5} disableEqualOverflow>
          <Grid xs={12} md={4}>
            <Card>
              ...
              <Box sx={{ p: 3 }}>
                <RadioGroup value={currentLang.value} onChange={(event) => onChangeLang(event.target.value)}>
                  {allLangs.map((lang) => (<FormControlLabel key={lang.label} value={lang.value} label={lang.label} control={<Radio />}/>))}
                </RadioGroup>
              </Box>
            </Card>
          </Grid>
          ...
          <Grid xs={12} md={8}>
            ...
            border: (theme) => `dashed 1px ${theme.palette.divider}`,
              ...
              <Card>
                ...
                <CardContent component={Stack} spacing={3} sx={{
            mx: 3,
            mb: 3,
            borderRadius: 2,
            typography: 'body2',
            ...
            border: (theme) => `dashed 1px ${theme.palette.divider}`,
                  ...
                  <Stack spacing={0.5}>
                    ...
                    {[2217.01, 247598.18, 677606.08, 4734447.51, 8471442.09].map((numb) => (<Box key={numb}>
                  ...
                  <Stack spacing={0.5}>
                    ...
                    {[1.7, 17.67, 28.1, 41.3, 91.16].map((numb) => (<Box key={numb}>
                        <Box component="span" sx={{ color: 'text.primary' }}>
                          {numb}
                        </Box>
                        <Box component="span" sx={{ color: 'text.secondary' }}>
                  ...
                  <Stack spacing={0.5}>
                    ...
                    {[719, 719.63, 3683.72, 5583407.51, 3345583407.51].map((numb) => (<Box key={numb}>
                        <Box component="span" sx={{ color: 'text.primary' }}>
                          {numb}
                        </Box>
                        <Box component="span" sx={{ color: 'text.secondary' }}>
                  ...
                  <Stack spacing={0.5}>
                    ...
                    {[356, 356.56, 3826.63, 7536340.92, 5679332343.62, 75344386390.46].map((numb) => (<Box key={numb}>
                          <Box component="span" sx={{ color: 'text.primary' }}>
                            {numb}
                          </Box>
                          <Box component="span" sx={{ color: 'text.secondary' }}>
                  ...
                  <Stack spacing={0.5}>
                    ...
                    {[451, 451.82, 1081.62, 27921.9, 600668.81, 7587054.86].map((numb) => (<Box key={numb}>
                        <Box component="span" sx={{ color: 'text.primary' }}>
                          {numb}
                        </Box>
                        <Box component="span" sx={{ color: 'text.secondary' }}>
