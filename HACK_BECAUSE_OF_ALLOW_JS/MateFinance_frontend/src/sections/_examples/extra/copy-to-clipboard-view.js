...
export default function CopyToClipboardView() {
  ...
  libero. Duis leo. Nulla porta dolor.`;
    ...
    return (<>
      <Container>
        <CustomBreadcrumbs heading="Copy To Clipboard" links={[{ name: 'Components', href: paths.components }, { name: 'Copy To Clipboard' }]}/>
      </Container>
        ...
        <Card sx={{ p: 5 }}>
          <Box display="grid" gridTemplateColumns={{ xs: 'repeat(1, 1fr)', md: 'repeat(2, 1fr)' }} gap={5}>
            <Stack spacing={2}>
              ...
              <TextField fullWidth value={value} onChange={handleChange} InputProps={{
