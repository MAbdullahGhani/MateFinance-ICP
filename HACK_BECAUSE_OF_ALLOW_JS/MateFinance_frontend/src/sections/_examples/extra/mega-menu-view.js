...
import { MegaMenuMobile, MegaMenuDesktopVertical, MegaMenuDesktopHorizontal, } from 'src/components/mega-menu';
...
export default function MegaMenuView() {
    ...
    const renderHorizontal = (<AppBar position="static" color="transparent" sx={{
            height: 72,
    ...
    const renderVertical = (<Stack direction="row" spacing={3} mt={5}>
    ...
    const renderMobile = (<>
      <Button color="inherit" variant="contained" onClick={mobileOpen.onTrue} startIcon={<Iconify icon="carbon:menu"/>}>
        Menu Mobile
      </Button>
    ...
    return (<>
      <ComponentHero>
        <CustomBreadcrumbs heading="Mega Menu" links={[
            {
                name: 'Components',
