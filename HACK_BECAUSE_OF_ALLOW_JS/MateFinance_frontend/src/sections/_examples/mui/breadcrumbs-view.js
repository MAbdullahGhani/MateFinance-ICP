...
export default function BreadcrumbsView() {
    return (<>
      <ComponentHero>
        <CustomBreadcrumbs heading="Breadcrumbs" links={[
            {
                name: 'Components',
      ...
      <Container sx={{ my: 10 }}>
        <Stack spacing={3}>
          ...
          <ComponentBlock title="With Icon" sx={{
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
        }}>
          ...
          <ComponentBlock title="Customized" spacing={5}>
            <CustomBreadcrumbs sx={{ width: 1 }} links={[
            {
                name: 'Home',
                href: '#',
            ...
            <CustomBreadcrumbs sx={{ width: 1 }} heading="Heading" links={[
            {
                name: 'Home',
                href: '#',
                icon: <Iconify icon="eva:home-fill"/>,
            ...
            { name: 'Link4', icon: <Iconify icon="eva:cube-outline"/> },
        ]} action={<Button variant="contained" startIcon={<Iconify icon="mingcute:add-line"/>}>
                  New Product
                </Button>}/>
          </ComponentBlock>
        </Stack>
