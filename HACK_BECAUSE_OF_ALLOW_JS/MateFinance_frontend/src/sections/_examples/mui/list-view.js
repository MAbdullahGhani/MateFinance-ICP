      ...
      <Container sx={{ my: 10 }}>
        <Masonry columns={{ xs: 1, md: 2 }} spacing={3}>
          ...
          <ComponentBlock title="Controls">
            ...
            return (<ListItemButton key={value} role={undefined} dense onClick={handleCheck(value)}>
                      <ListItemIcon>
          ...
          <ComponentBlock title="Switch">
            <Paper variant="outlined" sx={{ width: 1 }}>
              <List subheader={<ListSubheader>Settings</ListSubheader>}>
                <ListItemButton>
                  ...
                  <ListItemSecondaryAction>
                    <Switch edge="end" onChange={handleToggle('wifi')} checked={toggle.indexOf('wifi') !== -1} inputProps={{
            'aria-labelledby': 'switch-list-label-wifi',
                ...
                <ListItemButton>
                  ...
                  <ListItemSecondaryAction>
                    <Switch edge="end" onChange={handleToggle('bluetooth')} checked={toggle.indexOf('bluetooth') !== -1} inputProps={{
