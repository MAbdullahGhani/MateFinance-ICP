...
export default function MaxWidthDialog() {
    ...
    return (<>
      ...
      <Dialog open={dialog.value} maxWidth={maxWidth} onClose={dialog.onFalse} fullWidth={fullWidth}>
        ...
        <DialogContent>
          ...
          <Box component="form" noValidate sx={{
            ...
            <FormControlLabel control={<Switch checked={fullWidth} onChange={handleFullWidthChange}/>} label="Full width" sx={{ mt: 1 }}/>
          </Box>
        </DialogContent>
