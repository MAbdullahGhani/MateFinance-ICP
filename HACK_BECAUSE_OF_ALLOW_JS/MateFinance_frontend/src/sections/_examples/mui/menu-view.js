...
export default function MenuView() {
    ...
    return (<>
      <ComponentHero>
        <CustomBreadcrumbs heading="Menu" links={[
            {
                name: 'Components',
        ...
        <Box gap={3} display="grid" gridTemplateColumns={{
          ...
          <ComponentBlock title="Simple">
            ...
            <Menu id="simple-menu" anchorEl={isOpen} onClose={handleClose} open={Boolean(isOpen)}>
              {['Profile', 'My account', 'Logout'].map((option) => (<MenuItem key={option} selected={option === 'Profile'} onClick={handleClose}>
                  {option}
                </MenuItem>))}
            </Menu>
          </ComponentBlock>
          ...
          <ComponentBlock title="Max height">
            ...
            <Menu id="long-menu" anchorEl={isOpenMaxHeight} onClose={handleMaxHeightClose} open={Boolean(isOpenMaxHeight)} slotProps={{
            paper: {
                sx: {
                    width: '20ch',
                    maxHeight: 48 * 4.5,
              ...
              {OPTIONS_MAXHEIGHT.map((option) => (<MenuItem key={option} selected={option === 'Pyxis'} onClick={handleMaxHeightClose}>
                  {option}
                </MenuItem>))}
            </Menu>
          </ComponentBlock>
