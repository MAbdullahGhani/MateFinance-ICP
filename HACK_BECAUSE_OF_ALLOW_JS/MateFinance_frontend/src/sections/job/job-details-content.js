...
export default function JobDetailsContent({ job }) {
    ...
    const renderContent = (<Stack component={Card} spacing={3} sx={{ p: 3 }}>
      ...
      <Stack spacing={2}>
        ...
        <Stack direction="row" alignItems="center" spacing={1}>
          {skills.map((skill) => (<Chip key={skill} label={skill} variant="soft"/>))}
        </Stack>
      </Stack>
      ...
      <Stack spacing={2}>
        ...
        <Stack direction="row" alignItems="center" spacing={1}>
          {benefits.map((benefit) => (<Chip key={benefit} label={benefit} variant="soft"/>))}
        </Stack>
      </Stack>
    </Stack>);
    const renderOverview = (<Stack component={Card} spacing={2} sx={{ p: 3 }}>
      {[
            {
                label: 'Date Posted',
    ...
    const renderCompany = (<Stack component={Paper} variant="outlined" spacing={2} direction="row" sx={{ p: 3, borderRadius: 2, mt: 3 }}>
