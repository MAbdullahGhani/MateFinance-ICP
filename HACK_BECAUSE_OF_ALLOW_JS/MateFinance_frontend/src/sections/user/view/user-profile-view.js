    ...
    return (<Container maxWidth={settings.themeStretch ? false : 'lg'}>
      ...
      <Card sx={{
        ...
        <Tabs value={currentTab} onChange={handleChangeTab} sx={{
          ...
          {TABS.map((tab) => (<Tab key={tab.value} value={tab.value} icon={tab.icon} label={tab.label}/>))}
        </Tabs>
      </Card>
      ...
      {currentTab === 'friends' && (<ProfileFriends friends={_userFriends} searchFriends={searchFriends} onSearchFriends={handleSearchFriends}/>)}
