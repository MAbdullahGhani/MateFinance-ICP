...
export default function UserCard({ user }) {
    ...
    return (<Card sx={{ textAlign: 'center' }}>
      <Box sx={{ position: 'relative' }}>
        ...
        <Avatar alt={name} src={avatarUrl} sx={{
            width: 64,
            height: 64,
            zIndex: 11,
            left: 0,
      ...
      <ListItemText sx={{ mt: 7, mb: 1 }} primary={name} secondary={role} primaryTypographyProps={{ typography: 'subtitle1' }} secondaryTypographyProps={{ component: 'span', mt: 0.5 }}/>
