...
// ----------------------------------------------------------------------
export default function BorrowerDetailsHistory({ history }) {
    // const renderSummary = (
    //   <Stack
    //     spacing={2}
    //     component={Paper}
    ...
    //   </Stack>
    // );
    const renderTimeline = (<Timeline sx={{
            p: 0,
            m: 0,
      ...
      {history.map((item, index) => {
            ...
            return (<TimelineItem key={item.title}>
            <TimelineSeparator>
    ...
    return (<Card>
      ...
      <Stack spacing={3} alignItems={{ md: 'flex-start' }} direction={{ xs: 'column-reverse', md: 'row' }} sx={{ p: 3 }}>
        {renderTimeline}
...
BorrowerDetailsHistory.propTypes = {
