...
// ----------------------------------------------------------------------
export function MarketPlaceItemSkeleton({ variant = 'vertical', sx, ...other }) {
    const smUp = useResponsive('up', 'sm');
    if (variant === 'horizontal') {
        return (<Stack component={Paper} direction="row" variant="outlined" sx={{
                borderRadius: 2,
                ...sx,
            }} {...other}>
    ...
    return (<Stack component={Paper} variant="outlined" sx={{
            borderRadius: 2,
            ...sx,
        }} {...other}>
      <Stack sx={{ p: 1 }}>
...
MarketPlaceItemSkeleton.propTypes = {
    sx: PropTypes.object,
