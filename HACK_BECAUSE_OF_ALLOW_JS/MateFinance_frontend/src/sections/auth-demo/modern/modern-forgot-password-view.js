...
export default function ModernForgotPasswordView() {
    ...
    const renderForm = (<Stack spacing={3} alignItems="center">
      ...
      <LoadingButton fullWidth size="large" type="submit" variant="contained" loading={isSubmitting} endIcon={<Iconify icon="eva:arrow-ios-forward-fill"/>} sx={{ justifyContent: 'space-between', pl: 2, pr: 1.5 }}>
        Send Request
      </LoadingButton>
