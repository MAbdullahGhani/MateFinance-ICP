...
// components
import { Card, CardContent, Collapse, ListItemText, Stack, Tooltip, Typography, alpha, } from '@mui/material';
// import { useSelector } from 'react-redux';
import { varFade } from 'src/components/animate';
import FileThumbnail from 'src/components/file-thumbnail';
import Iconify from 'src/components/iconify';
import Scrollbar from 'src/components/scrollbar';
import { TableEmptyRows, TableHeadCustom, TableNoData, TablePaginationCustom, emptyRows, getComparator, useTable, } from 'src/components/table';
          ...
          <Table size={table.dense ? 'small' : 'medium'} sx={{ minWidth: 800 }}>
            ...
            .map((row, index) => (<>
                ...
                cursor: 'pointer',
                      ...
                      <TableCell>
                        {docTypeSet.has(row) ? (<Iconify icon="game-icons:check-mark" color="primary"/>) : null}
                      </TableCell>
                    </TableRow>
                ...
                .map((doc, docIndex) => (<Collapse in={expanded === doc.docType} unmountOnExit>
                              <Stack {...varFade().inUp} spacing={1} direction="row" alignItems="center" sx={{
                    my: 1,
                    py: 1,
                    px: 1.5,
                    borderRadius: 1,
