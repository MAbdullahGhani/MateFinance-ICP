...
export default function SupabaseVerifyView() {
    ...
    return (<>
      ...
      <Button component={RouterLink} href={paths.auth.supabase.login} size="large" color="inherit" variant="contained" startIcon={<Iconify icon="eva:arrow-ios-back-fill"/>} sx={{ alignSelf: 'center' }}>
        Return to Sign in
      </Button>
    </>);
}
