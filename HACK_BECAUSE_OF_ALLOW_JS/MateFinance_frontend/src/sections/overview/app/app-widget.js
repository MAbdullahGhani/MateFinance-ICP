...
export default function AppWidget({ title, total, icon, color = 'primary', chart, sx, ...other }) {
    ...
    return (<Stack direction="row" alignItems="center" sx={{
      ...
      <Chart dir="ltr" type="radialBar" series={[series]} options={chartOptions} width={86} height={86}/>

      <ListItemText sx={{ ml: 3 }} primary={fNumber(total)} secondary={title} primaryTypographyProps={{
            typography: 'h4',
            component: 'span',
