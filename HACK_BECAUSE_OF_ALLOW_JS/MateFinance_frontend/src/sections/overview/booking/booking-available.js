...
export default function BookingAvailable({ title, subheader, chart, ...other }) {
    ...
    return (<Card {...other}>
      ...
      <Chart dir="ltr" type="radialBar" series={[chartSeries]} options={chartOptions} width="100%" height={310}/>

      <Stack spacing={2} sx={{ p: 5 }}>
        {series.map((item) => (<Stack key={item.label} spacing={1} direction="row" alignItems="center" sx={{
