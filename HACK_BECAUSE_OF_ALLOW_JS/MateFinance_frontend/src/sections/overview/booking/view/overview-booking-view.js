      ...
      <Grid container spacing={SPACING} disableEqualOverflow>
        ...
        <Grid container xs={12}>
          <Grid container xs={12} md={8}>
            <Grid xs={12} md={6}>
              <BookingTotalIncomes title="Total Incomes" total={18765} percent={2.6} chart={{
            series: [
                { x: 2016, y: 111 },
                { x: 2017, y: 136 },
                { x: 2018, y: 76 },
            ...
            <Grid xs={12}>
              <BookingStatistics title="Statistics" subheader="(+43% Sold | +12% Canceled) than last year" chart={{
          ...
          <Grid xs={12} md={4}>
            <BookingAvailable title="Tours Available" chart={{
            series: [
            ...
            <BookingCustomerReviews title="Customer Reviews" subheader={`${_bookingReview.length} Reviews`} list={_bookingReview} sx={{ mt: SPACING }}/>
          </Grid>
        </Grid>
        ...
        <Grid xs={12}>
          <BookingDetails title="Booking Details" tableData={_bookings} tableLabels={[
