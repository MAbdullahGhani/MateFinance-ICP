        ...
        <Grid container sx={{ marginTop: 3 }} justifyContent="space-between">
          <Grid item sm={12} md={6} lg={6}>
            ...
            '& .MuiCardContent-root': {
              ...
              <CardHeader title={<Typography onClick={() => handleShowBankStatement(financialDetail?.monthBankStatement || '')}>
                    {financialDetail?.monthBankStatement
                ? 'View Bank Statement'
                : 'Bank Statement not found'}{' '}
                  </Typography>} subheader=""/>
              <CardContent>
                {financialDetail?.monthBankStatement && (<IconButton onClick={() => handleShowBankStatement(financialDetail?.monthBankStatement || '')}>
